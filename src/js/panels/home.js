...
class Home {
    ...
    async initNews() {
        ...
        if (this.news) {
            if (!this.news.length) {
                ...
                blockNews.innerHTML = `
                    ...
                    <div class="news-content">
                        <div class="bbWrapper">
                            <p>Subiremos todas las noticias acerca de el servidor</p>
                        </div>
                    </div>`
                ...
                for (let News of this.news) {
                    ...
                    blockNews.innerHTML = `
                        <div class="news-header">
                            ...
                            <div class="date">
                                <div class="día">${date.day}</div>
                                <div class="mes">${date.month}</div>
                            </div>
                        </div>
                        <div class="news-content">
                            <div class="bbWrapper">
            ...
            blockNews.innerHTML = `
                ...
                <div class="news-content">
                    <div class="bbWrapper">
                        <p>Imposible contactar con las noticias del servidor</br>Gracias por confirmar tu conexión</p>
                    </div>
                </div>`
            // news.appendChild(blockNews);
        }
    ...
    async initStatusServer() {
        ...
        if (!serverPing.error) {
            ...
            nameServer.textContent = 'Servidor inactivo';
