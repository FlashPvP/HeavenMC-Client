...
class Login {
    ...
    getOnline() {
        ...
        console.log(`Iniciando panel de mojang`)
        this.loginMicrosoft();
        this.loginMojang();
    ...
    getOffline() {
        console.log(`Iniciando panel de microsoft`)
        console.log(`Iniciando panel de mojang`)
        console.log(`Iniciando panel pirata`)
        this.loginMicrosoft();
        this.loginOffline();
        document.querySelector('.cancel-login').addEventListener("click", () => {
            document.querySelector(".cancel-login").style.display = "none";
    ...
    loginMojang() {
        ...
        loginBtn.addEventListener("click", () => {
            ...
            if (mailInput.value == "") {
                infoLogin.innerHTML = "Introduzca su correo / usuario no premium"
            ...
            if (passwordInput.value == "") {
                infoLogin.innerHTML = "Introduzca una contraseña / sin contraseña"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
            ...
            Mojang.getAuth(mailInput.value, passwordInput.value).then(account_connect => {
                ...
                mailInput.disabled = false;
                passwordInput.disabled = false;
                infoLogin.innerHTML = 'Dirección de correo electrónico inválido'
            })
        })
    }
    ...
    loginOffline() {
        ...
        mojangBtn.innerHTML = "Fuera de línea"
        ...
        loginBtn.addEventListener("click", () => {
            ...
            if (mailInput.value.length < 3) {
                infoLogin.innerHTML = "Deberá introducir almenos 3 carácteres"
                cancelMojangBtn.disabled = false;
                loginBtn.disabled = false;
                mailInput.disabled = false;
                passwordInput.disabled = false;
            ...
            Mojang.getAuth(mailInput.value, passwordInput.value).then(async account_connect => {
                ...
                mailInput.disabled = false;
                passwordInput.disabled = false;
                infoLogin.innerHTML = 'Dirección de correo o contraseña inválidos'
            })
        })
    }
}
